...
if(isset($_POST['login'])){
  ...
  $log_query = "select * from admin_signup where email = '$login_email'";
			...
			<form action="<?php echo $_SERVER['PHP_SELF'];?>" method="POST" class="billing-form ftco-bg-dark p-3 p-md-5">
				<h3 class="mb-4 billing-heading">Login</h3>
	          	<div class="row align-items-end">
	                ...
	                <div class="form-group">
	                  ...
	                  <input type="text" class="form-control" name="log_email" placeholder="Email">
	                </div>
	              </div>
                ...
                <div class="col-md-12">
                	<div class="form-group mt-4">
							<div class="radio">
                                <button class="btn btn-primary py-3 px-4" name="login">Login</button>
						    </div>
					</div>
                </div>
