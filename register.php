  ...
  @keyframes thing {
    ...
    to{
        transform: scale(1.9, 1.9);
          ...
          <div id="main-slider" class="slid1" style="height:750px"> <!-- Slider -->
              <div id="home-slider" class="owl-carousel owl-theme">
                  <div class="item" id="zoom1">
                      <img src="images/blush2.jpg." alt="slide-1" class="img-responsive">
                      <div class="slider-desc"
                          <div class="container">
                          <div class="row slider-text justify-content-center align-items-center">

<div class="col-md-7 col-sm-12 text-center ftco-animate">
  <h1 class="mb-3 mt-5 bread" style="margin-left:900px; margin-top:300px;"> Register</h1>
  <p class="breadcrumbs"style="margin-left:900px;"><span class="mr-2"><a href="index.php">Home</a></span>!<span>Register</span></p>
</div>
