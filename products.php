<?php
 ...
 if(isset($_POST['add_to_cart'])){
    ...
    $select_cart = mysqli_query($connection, "SELECT * FROM `cart` WHERE title = $product_title");
    if(mysqli_num_rows($select_cart) > 0){
        $message[]= 'product already added to cart';

    }else{
        $insert_product= mysqli_query($connection, "INSERT INTO `cart`(title, price, image , quantity) 
         VALUES('$product_title','$product_price', '$product_image', ' $product_quantity')");
													...
													<div class="product-fade-wrap">
														...
														<div class="product-fade-ct">
                                                            <div class="product-fade-control">
                                                                ...
                                                                <a href="cart.php" class="btn btn-to-cart"name="add_to_cart" style="font-size: 60%; width: 75%; height: 30%;"><span class="bag"></span><span>Add To cart</span><div class="clearfix"></div></a>
                                                            </div>
