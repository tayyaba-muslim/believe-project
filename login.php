        ...
        transform: scale(1.9, 1.9);
          ...
          <div id="main-slider" class="slid1" style="height:750px"> <!-- Slider -->
            ...
            <div class="col-md-7 col-sm-12 text-center ftco-animate">
            	<h1 class="mb-3 mt-5 bread" style="margin-left:900px; margin-top:300px;"> Login</h1>
	            <p class="breadcrumbs"style="margin-left:900px;"><span class="mr-2"><a href="index.php">Home</a></span>!<span>Login</span></p>
            </div>
